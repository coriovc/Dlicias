...
<body onload="startTime()">
      ...
      ?>
  <header class="page-header bg-img-cover overlay overlay-30" style="background-image: url(../../imagenes/fond-color2.jpg);">
    <div class="container" style="margin-top: 6rem;">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="display-3 tct text-white">Ingredientes y Productos</h1>
          <i class="material-icons-round icon-head">category</i>
        </div>
      </div>
    </div>
  </header>
