        ...
        <div class="col-lg-3 mb-4">
          <div class="card o-visible mb-4 mt-4">
              <div class="card-body">
                ...
                <div>
                  <h6>Usuario</h6>
                  <h4><!--<?php echo $value->usuario;?>-->Coriovc</h4>
                </div>
                
                <div>
                  <h6>Nombre y Apellido</h6>
                  <h4><!--<?php echo $value->nombre." ".$value->apellido;?>-->Victor Corio</h4>
                </div>

                <div>
                  <h6>Correo</h6>
                  <h4><!--<?php echo $value->email;?>-->Victor@gmail.com</h4>
                </div>
          ...
          <div class="mdl-tabs__panel" id="seccion-2">
            <div class="row align-items-center my-5">
              <div class="col">
                ...
                <div class="text-center">
                  <img style="width: 90%;" src="../imagenes/updated-layouts-collab.png"/>
                </div>

                <div class="d-flex align-items-center justify-content-center my-4">
                  
                  <a class="btn btn-yellow btn-sm rounded-pill lift-btn tct text-white"><h6 style="margin-bottom: 0;">Crear Copia de seguridad</h6><i class="material-icons-round ml-2">backup</i>
                  </a>
                </div>
              </div>
                  ...
                  <h2 class="yellow" >Bitacora</h2>
                        ...
                        <table class="table" width="100%">
                          ...
                          <tbody>
                              <tr>
                                <td>Coriovc</td>
                                <td><div class="badge badge-primary badge-pill">Adminstrador</div></td>
                                <td>Registro una venta</td>
                                <td>2011/04/25</td>
                                <td>12:00 PM</td>
                                <td>
                                  <button class="btn btn-sm btn-icon btn-transparent-dark mr-2"><span class="material-icons-round">more_vert</span></button>
                              ...
                              <tr>
                                <td>Jan de sousa</td>
                                <td><div class="badge badge-warning badge-pill">Brige</div></td>
                                <td>Registro una compra</td>
                                <td>2011/04/25</td>
                                <td>12:00 PM</td>
                                <td>
                              ...
                              <tr>
                                <td>Luis Alfonzo</td>
                                <td><div class="badge badge-secondary badge-pill">otro</div></td>
                                <td>Registro un articulo</td>
                                <td>2011/04/25</td>
                                <td>12:00 PM</td>
                                <td>
                                  <button class="btn btn-sm btn-icon btn-transparent-dark mr-2"><span class="material-icons-round">more_vert</span></button>
                    ...
                    <div class="card-header">
                      <i class="material-icons-round grand red">auto_delete</i>
                        ...
                        <table class="table" width="100%">
                          ...
                          <tbody>
                              <td><div class="btn btn-red btn-sm"><strong>COD-0001</strong></div></td>
                              <td>Articulo</td>
                              <td>Victor</td>
                              <td>2011/04/25</td>
                              <td align="right">
