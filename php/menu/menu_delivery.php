...
<!--delivey -->
      <li id="gestion"class="nav-item mr-2">        
        <div class="d-inline d-md-none">
          <a class="btn btn-white active btn-icon" href="../gestion/">
          <span class="text-primary material-icons-round">layers</span></a>
        </div>
        
        <div class="d-none  d-md-inline">
          <a class="btn btn-white active rounded-pill" href="../gestion/">
          <span class="text-primary mr-2 material-icons-round">layers</span>
          Gestión</a>
        </div>
      </li> 
<!--Ajustes-->
