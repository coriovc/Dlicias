...
<!--Dashboar-->
      <li id="Dashboard"class="nav-item mr-2">
        <div class="d-inline d-md-none">
          <a class="btn btn-white active btn-icon" href="Dashboard.php">
        <span class="text-primary material-icons-round">amp_stories</span></a>
        </div>
          
        <div class="d-none d-md-inline">
          <a class="btn btn-white active" href="Dashboard.php">
          <span class="text-primary mr-2 material-icons-round">amp_stories</span>
          Dashboard</a>
        </div>
      </li>
<!--Compras
