...
<!--Dashboar-->
      <li id="Dashboard"class="nav-item mr-2">
        <div class="d-inline d-md-none">
          <a class="btn btn-transparent-dark btn-icon" href="Dashboard.php">
        <span class="material-icons-round">amp_stories</span></a>
        </div>
          
        <div class="d-none  d-md-inline">
          <a class="btn btn-transparent-dark rounded-pill" href="Dashboard.php">
...
<!--Compras
      <li id="compras"class="nav-item mr-2">        
        <div class="d-inline d-md-none">
          <a class="btn btn-transparent-dark btn-icon" href="compras.php">
          <span class="material-icons-round">shopping_basket</span></a>
        </div>

        <div class="d-none  d-md-inline">
          <a class="btn btn-transparent-dark rounded-pill " href="compras.php">
...
<!--Ventas-->
      <li id="ventas"class="nav-item mr-2">        
        <div class="d-inline d-md-none">
          <a class="btn btn-transparent-dark btn-icon" href="Ventas.php">
          <span class="material-icons-round">payment</span></a>
        </div>
        
        <div class="d-none  d-md-inline">
          <a class="btn btn-transparent-dark rounded-pill" href="Ventas.php">
...
<!--Productos-->
      <li id="productos"class="nav-item mr-2">        
        <div class="d-inline d-md-none">
          <a class="btn btn-transparent-dark btn-icon" href="productos.php">
          <span class="text-primary material-icons-round">category</span></a>
        </div>
        
        <div class="d-none  d-md-inline">
          <a class="btn btn-transparent-dark rounded-pill" href="productos.php">
...
<!--Inventario-->
      <li id="inventario"class="nav-item mr-2">        
        <div class="d-inline d-md-none">
          <a class="btn btn-transparent-dark btn-icon" href="Inventario.php">
          <span class="material-icons-round">bubble_chart</span></a>
        </div>
        
        <div class="d-none  d-md-inline">
          <a class="btn btn-transparent-dark rounded-pill" href="Inventario.php">
...
<!--Empleados-->
      <li id="empleados"class="nav-item mr-2">        
        <div class="d-inline d-md-none">
          <a class="btn btn-transparent-dark btn-icon" href="empleados.php">
          <span class="material-icons-round">supervised_user_circle</span></a>
        </div>
        
        <div class="d-none  d-md-inline">
          <a class="btn btn-transparent-dark rounded-pill" href="empleados.php">
...
<!--Info
      <li id="info"class="nav-item mr-2">        
        <div class="d-inline d-md-none">
          <a class="btn btn-transparent-dark btn-icon" href="info.php">
          <span class="material-icons-round">info</span></a>
        </div>
        
        <div class="d-none  d-md-inline">
          <a class="btn btn-transparent-dark rounded-pill" href="info.php">
