...
<!--Dashboar-->
      <li id="Dashboard"class="nav-item mr-2">
        <div class="d-inline d-md-none">
          <a class="btn btn-transparent-dark btn-icon" href="../Dashboard/">
        <span class="material-icons-round">space_dashboard</span></a>
        </div>
          
        <div class="d-none  d-md-inline">
          <a class="btn btn-transparent-dark rounded-pill" href="../Dashboard/">
...
<!--Compras
      <li id="compras"class="nav-item mr-2">        
        <div class="d-inline d-md-none">
          <a class="btn btn-transparent-dark btn-icon" href="../compras/">
          <span class="material-icons-round">shopping_basket</span></a>
        </div>

        <div class="d-none  d-md-inline">
          <a class="btn btn-transparent-dark rounded-pill " href="../compras/">
...
<!--Ventas-->
      <li id="ventas"class="nav-item mr-2">        
        <div class="d-inline d-md-none">
          <a class="btn btn-transparent-dark btn-icon" href="../Ventas/">
          <span class="material-icons-round">payment</span></a>
        </div>
        
        <div class="d-none  d-md-inline">
          <a class="btn btn-transparent-dark rounded-pill" href="../Ventas/">
...
<!--Productos-->
      <li id="productos"class="nav-item mr-2">        
        <div class="d-inline d-md-none">
          <a class="btn btn-transparent-dark btn-icon" href="../productos/">
          <span class="material-icons-round">category</span></a>
        </div>
        
        <div class="d-none  d-md-inline">
          <a class="btn btn-transparent-dark rounded-pill" href="../productos/">
...
<!--Inventario-->
      <li id="inventario"class="nav-item mr-2">        
        <div class="d-inline d-md-none">
          <a class="btn btn-transparent-dark btn-icon" href="../Inventario/">
          <span class="material-icons-round">inventory</span></a>
        </div>
        
        <div class="d-none  d-md-inline">
          <a class="btn btn-transparent-dark rounded-pill" href="../Inventario/">
...
<!--Empleados-->
      <li id="empleados"class="nav-item mr-2">        
        <div class="d-inline d-md-none">
          <a class="btn btn-transparent-dark btn-icon" href="../empleados/">
          <span class="material-icons-round">supervised_user_circle</span></a>
        </div>
        
        <div class="d-none  d-md-inline">
          <a class="btn btn-transparent-dark rounded-pill" href="../empleados/">
...
<!--Ajustes-->
      <li id="ajustes"class="nav-item mr-2">        
        <div class="d-inline d-md-none">
          ...
          <span class="text-red material-icons-round">settings</span></a>
        </div>
        
        <div class="d-none  d-md-inline">
          <a class="btn btn-white active" href="../ajustes/">
          <span class="text-red mr-2 material-icons-round">settings</span>
          Perfil</a>
        </div>
      </li>   
