...
<!--Compras
      <li id="compras"class="nav-item mr-2">        
        <div class="d-inline d-md-none">
          <a class="btn btn-white active btn-icon" href="compras.php">
          <span class="text-primary material-icons-round">shopping_basket</span></a>
        </div>

        <div class="d-none  d-md-inline">
          <a class="btn btn-white active" href="compras.php">
          <span class="text-primary mr-2 material-icons-round">shopping_basket</span>
          Compras</a>
        </div>
      </li>-->
<!--Ventas-->
...
<!--Empleados-->
      <li id="empleados"class="nav-item mr-2">        
        <div class="d-inline d-md-none">
          <a class="btn btn-transparent-light btn-icon" href="empleados.php">
          <span class="material-icons-round">supervised_user_circle</span></a>
        </div>
        
        <div class="d-none  d-md-inline">
          <a class="btn btn-transparent-light rounded-pill" href="empleados.php">
