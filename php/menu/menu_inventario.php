...
<!--Inventario-->
      <li id="inventario"class="nav-item mr-2">        
        <div class="d-inline d-md-none">
          <a class="btn btn-white active btn-icon " href="Inventario.php">
          <span class="text-primary material-icons-round">bubble_chart</span></a>
        </div>
        
        <div class="d-none  d-md-inline">
          <a class="btn btn-white active" href="Inventario.php">
...
<!--Ajustes-->
      <li id="ajustes"class="nav-item mr-2">        
        <div class="d-inline d-md-none">
          <a class="btn btn-transparent-dark btn-icon" href="ajustes.php">
          <span class="material-icons-round">admin_panel_settings</span></a>
        </div>
        
        <div class="d-none  d-md-inline">
          <a class="btn btn-transparent-dark rounded-pill" href="ajustes.php">
