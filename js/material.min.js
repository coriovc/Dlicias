...
(function() {
  ...
  showToastButton.addEventListener('click', function() {
    'use strict';
    var data = {message: 'mensaje numero 1 ' + ++counter};
...
mport {MDCTextField} from '@material/textfield';
...
window.addEventListener("load",function(){document.querySelector(".js-main").classList.add("main--active");

	document.querySelector(".js-loader").classList.add("yt-hide");document.documentElement.classList.remove("no-scroll");aa.init();fa.init();ga.init();ia.init();na.init();oa.init();da.init();ra.init();ta.init();va.init();ya.init()});}).call(window)
